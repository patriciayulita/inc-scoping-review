...
% band_width         - band_width of smoothing kernel (default = 0.3)
% xlim_ks           - xlimit of the smoothing (default = 'unbounded')
...
addOptional(p, 'xlim_ks', []) % add optional input for defining the xlim of the smoothing
...
xlim_ks             = p.Results.xlim_ks % add new handling for xlim of smoothing

% calculate kernel density
switch density_type
    case 'ks'
        [f, Xi, u] = ksdensity(X, 'bandwidth', band_width,'support',xlim_ks); % add new handling for xlim of smoothing
